...
if __name__ == "__main__":
    ...
    parser.add_argument('--respth', type=str, default=r'C:\temp11', help='Path to save the parsing results')
    parser.add_argument('--dspth', type=str, default=r'C:\dumpinGGrounds\stuff_pg\outputs\Sherlyn', help='Path to the directory containing input images')
    parser.add_argument('--cp', type=str, default='model_final_diss.pth', help='Path to the trained model checkpoint')
    args = parser.parse_args()

    # evaluate(args.respth, args.dspth,  cp='79999_iter.pth')    
    # evaluate(dspth=r'C:\dumpinGGrounds\stuff_pg\outputs\Sherlyn', cp='79999_iter.pth')
    evaluate(dspth=r'C:\dumpinGGrounds\cropped_faces\fapelo',respth=r'C:\dumpinGGrounds\masks',cp='79999_iter.pth')
